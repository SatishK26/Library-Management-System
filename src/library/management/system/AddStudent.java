...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "MCA", "B.E", "B.Tech", "M.Tech", "MBA", "BBA", "BCA", "B.Sc", "M.Sc", "B.Com", "M.Com" }));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                if(!Pattern.matches("^[a-zA-Z]{4,30}$",t2.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only alphabets for name field");
                }
                else if(!Pattern.matches("^[a-zA-Z]{4,30}$",t3.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only alphabets for father field");
                }
                else
                {
