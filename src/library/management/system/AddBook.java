    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                if(!Pattern.matches("^[a-zA-Z]{1,35}$",t2.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only alphabets for name field");
                }
                 else if(!Pattern.matches("^[0-9]{13}$",t3.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only numeric data for ISBN field");
                }
                 
                 else if(!Pattern.matches("^[a-zA-Z]{3,30}$",t4.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only alphabets for Publisher field");
                }
                 
                else if(!Pattern.matches("^[0-9]{2,4}$",t5.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only numeric data for price field");
                }
                 else if(!Pattern.matches("^[0-9]{2,4}$",t6.getText())){
                    JOptionPane.showMessageDialog(this,"Enter only numeric data for pages field");
                }
